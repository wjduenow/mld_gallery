...
$(function () {
    ...
    $.ajax({
        ...
        url: 'https://picasaweb.google.com/data/feed/base/user/114638103747249970399/albumid/6107211468378792641?alt=json',
        //data: {
        //    #format: 'json',
    ...
    $('#image-gallery-button').on('click', function (event) {
        ...
        blueimp.Gallery($('#links_studies a'), $('#blueimp-gallery').data());
    });
